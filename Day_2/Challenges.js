...
const getInputAsArray = input => input.split(/\r?\n/);

const countOccurrences = (arr, val) => arr.reduce((a, v) => (v === val ? a + 1 : a), 0);

const checkPasswordValidity = (range = [], keyAlphabet = "", password = "") => {
    if(!range.length || !keyAlphabet || !password) return console.log("Cannot check validity, insufficient parameters");

    const countofKeyAlphabet = countOccurrences(password.split(""), keyAlphabet);
